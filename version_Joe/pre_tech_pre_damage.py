...
'''
v_nn_config_5   = {"n_layers" :num_hidden_layers,  "layer_width" : num_neurons, 'input_dim':5,"nn_name" : "v_nn"}

i_g_nn_config_5 = {"n_layers" : num_hidden_layers,  "layer_width" : num_neurons, 'input_dim':5,"nn_name" : "i_g_nn"}

i_d_nn_config_5 = {"n_layers" : num_hidden_layers,  "layer_width" : num_neurons,'input_dim':5, "nn_name" : "i_d_nn"}

i_I_nn_config_5 = {"n_layers" : num_hidden_layers,  "layer_width" : num_neurons, 'input_dim':5,"nn_name" : "i_I_nn"}

   
v_nn_config_4   = {"n_layers" : num_hidden_layers,  "layer_width" : num_neurons, 'input_dim':4,"nn_name" : "v_nn"}

i_g_nn_config_4 = {"n_layers" : num_hidden_layers,  "layer_width" : num_neurons, 'input_dim':4,"nn_name" : "i_g_nn"}

i_d_nn_config_4 = {"n_layers" : num_hidden_layers,  "layer_width" : num_neurons,'input_dim':4, "nn_name" : "i_d_nn"}
i_I_nn_config_4 = {"n_layers" : num_hidden_layers,  "layer_width" : num_neurons, 'input_dim':4,"nn_name" : "i_I_nn"}

   

v_nn_config_6  = {"n_layers" : num_hidden_layers,  "layer_width" : num_neurons, 'input_dim':6,"nn_name" : "v_nn"}

i_g_nn_config_6 = {"n_layers" : num_hidden_layers,  "layer_width" : num_neurons, 'input_dim':6,"nn_name" : "i_g_nn"}

i_d_nn_config_6 = {"n_layers" :num_hidden_layers,  "layer_width" : num_neurons,'input_dim':6, "nn_name" : "i_d_nn"}

i_I_nn_config_6 = {"n_layers" : num_hidden_layers,  "layer_width" : num_neurons, 'input_dim':6,"nn_name" : "i_I_nn"}
...
"v_nn_config_4" : v_nn_config_4, "i_g_nn_config_4" : i_g_nn_config_4, "i_d_nn_config_4" : i_d_nn_config_4, \
"v_nn_config_5" : v_nn_config_5, "i_g_nn_config_5" : i_g_nn_config_5, "i_d_nn_config_5" : i_d_nn_config_5, \
"v_nn_config_6" : v_nn_config_6, "i_g_nn_config_6" : i_g_nn_config_6, "i_d_nn_config_6" : i_d_nn_config_6, \
...
params["i_I_nn_config_5"]         = i_I_nn_config_5
params["i_I_nn_config_6"]         = i_I_nn_config_6
